srcdir = /source/php-5.3.27/ext/shurrik
builddir = /source/php-5.3.27/ext/shurrik
top_srcdir = /source/php-5.3.27/ext/shurrik
top_builddir = /source/php-5.3.27/ext/shurrik
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/data/local/php/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/data/local/php/bin/php-config'
...
prefix = /data/local/php
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /data/local/php
phplibdir = /source/php-5.3.27/ext/shurrik/modules
phpincludedir = /data/local/php/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /data/local/php/lib/php/extensions/no-debug-non-zts-20090626
PHP_EXECUTABLE = /data/local/php/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/data/local/php/include/php -I/data/local/php/include/php/main -I/data/local/php/include/php/TSRM -I/data/local/php/include/php/Zend -I/data/local/php/include/php/ext -I/data/local/php/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
